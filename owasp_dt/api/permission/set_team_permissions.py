...
from ...models.team_permissions_set_request import TeamPermissionsSetRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: TeamPermissionsSetRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v1/permission/team",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (TeamPermissionsSetRequest | Unset):

...
from ...models.create_notification_rule_request import CreateNotificationRuleRequest
...
def _get_kwargs(
    *,
    body: CreateNotificationRuleRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateNotificationRuleRequest | Unset):

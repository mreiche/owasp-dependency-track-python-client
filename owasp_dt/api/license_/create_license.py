...
from ...models.create_license_request import CreateLicenseRequest
...
def _get_kwargs(
    *,
    body: CreateLicenseRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = LicenseResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateLicenseRequest | Unset):

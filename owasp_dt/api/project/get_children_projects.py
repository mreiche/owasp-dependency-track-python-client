...
from ...models.get_children_projects_sort_order import GetChildrenProjectsSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    sort_order: GetChildrenProjectsSortOrder | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/project/{uuid}/children".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        limit (str | Unset):
        sort_name (str | Unset):
        sort_order (GetChildrenProjectsSortOrder | Unset):

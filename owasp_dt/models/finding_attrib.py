...
class FindingAttrib:
    """
    Attributes:
        attributed_on (int | Unset): UNIX epoch timestamp in milliseconds
        analyzer_identity (FindingAttribAnalyzerIdentity | Unset):
        component (Component | Unset):
        vulnerability (Vulnerability | Unset):
        alternate_identifier (str | Unset):
        reference_url (str | Unset):
        uuid (UUID | Unset):
    """

    attributed_on: int | Unset = UNSET
    analyzer_identity: FindingAttribAnalyzerIdentity | Unset = UNSET
    component: Component | Unset = UNSET
    vulnerability: Vulnerability | Unset = UNSET
    alternate_identifier: str | Unset = UNSET
    reference_url: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        analyzer_identity: str | Unset = UNSET

...
T = TypeVar("T", bound="CreateVulnPolicyRequest")


@_attrs_define
class CreateVulnPolicyRequest:
    """
    Attributes:
        name (str):
        condition (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_vuln_policy_request = cls(
            name=name,
            condition=condition,
            analysis=analysis,
        ...
        create_vuln_policy_request.additional_properties = d
        return create_vuln_policy_request

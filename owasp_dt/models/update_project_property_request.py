...
T = TypeVar("T", bound="UpdateProjectPropertyRequest")


@_attrs_define
class UpdateProjectPropertyRequest:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_project_property_request = cls(
            group_name=group_name,
            property_name=property_name,
            property_value=property_value,
        )

        update_project_property_request.additional_properties = d
        return update_project_property_request

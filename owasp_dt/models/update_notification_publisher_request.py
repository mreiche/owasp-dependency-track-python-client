...
T = TypeVar("T", bound="UpdateNotificationPublisherRequest")


@_attrs_define
class UpdateNotificationPublisherRequest:
    """
    Attributes:
        extension_name (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_notification_publisher_request = cls(
        ...
        update_notification_publisher_request.additional_properties = d
        return update_notification_publisher_request

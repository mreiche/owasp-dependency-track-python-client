...
from ...models.get_extension_config_response import GetExtensionConfigResponse
...
) -> GetExtensionConfigResponse | ProblemDetails:
    if response.status_code == 200:
        response_200 = GetExtensionConfigResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetExtensionConfigResponse | ProblemDetails]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> GetExtensionConfigResponse | ProblemDetails | None:
    """Get extension configuration

...
from ...models.vuln_data_source_mirror_status import VulnDataSourceMirrorStatus
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/vuln-data-sources/{name}/mirror-runs/latest".format(
...
) -> ProblemDetails | VulnDataSourceMirrorStatus:
    if response.status_code == 200:
        response_200 = VulnDataSourceMirrorStatus.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ProblemDetails | VulnDataSourceMirrorStatus]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ProblemDetails | VulnDataSourceMirrorStatus | None:
    """Get the latest vulnerability data source mirror run

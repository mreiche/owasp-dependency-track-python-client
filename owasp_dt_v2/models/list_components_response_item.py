...
if TYPE_CHECKING:
    from ..models.component_project import ComponentProject
...
T = TypeVar("T", bound="ListComponentsResponseItem")


@_attrs_define
class ListComponentsResponseItem:
    """
    Attributes:
        name (str):
        uuid (UUID):
        ...
        project (ComponentProject | Unset):
    ...
    project: ComponentProject | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_project, Unset):
            ...
            project = ComponentProject.from_dict(_project)
        ...
        list_components_response_item = cls(
            name=name,
            uuid=uuid,
            version=version,
            group=group,
        ...
        list_components_response_item.additional_properties = d
        return list_components_response_item

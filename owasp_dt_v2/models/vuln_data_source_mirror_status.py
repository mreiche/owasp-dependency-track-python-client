...
from ..models.vuln_data_source_mirror_status_status import (
    VulnDataSourceMirrorStatusStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VulnDataSourceMirrorStatus")


@_attrs_define
class VulnDataSourceMirrorStatus:
    """
    Attributes:
        status (VulnDataSourceMirrorStatusStatus): Status of the mirror run.
    ...
    status: VulnDataSourceMirrorStatusStatus
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        status = VulnDataSourceMirrorStatusStatus(d.pop("status"))
        ...
        vuln_data_source_mirror_status = cls(
            status=status,
        ...
        vuln_data_source_mirror_status.additional_properties = d
        return vuln_data_source_mirror_status
